...
// Provide a const array with non-const characters, specify the number of characters and the maximum number of bytes for each individual array, as well as the number of borders you provide.
